...
public class flipUp extends Command {
  ...
  @Override
  public void execute() {
    flippy.leftPivot.setVoltage(pid.calculate(flippy.wristAngle, 135) + feedforward.calculate(flippy.wristAngle, 0));
    flippy.rightPivot.setVoltage(pid.calculate(flippy.wristAngle, 135) + feedforward.calculate(flippy.wristAngle, 0));
  }
